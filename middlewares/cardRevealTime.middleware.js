...
export const ManageCardRevealTimeMiddleware = async function(req, res, next) {
    try {
        if(!req.body){
            return res.status(500).json(new ApiError(500,"Card Reveal Time Request!", "Empty Request body."));
        };

...
const currentBetOnCardSchema = new mongoose.Schema(
    {
        sess_user_id : {
...
*/
const Current_bet_on_card = mongoose.models.current_bet_on_cards || mongoose.model('Current_bet_on_card',currentBetOnCardSchema);
export default Current_bet_on_card;
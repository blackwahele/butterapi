...
const currentBetByUserSchema = new mongoose.Schema(
    {
        current_session_id : {
...
*/
const Current_bet_by_user = mongoose.models.current_bet_by_users || mongoose.model('Current_bet_by_user',currentBetByUserSchema);
export default Current_bet_by_user;
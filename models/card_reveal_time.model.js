...
const cardRevealTimeSchema = new mongoose.Schema(
    {
        timeInMin : {
            type: Number,
            required: true,
...
*/
const Card_reveal_time = mongoose.models.card_reveal_times || mongoose.model('Card_reveal_time',cardRevealTimeSchema);
export default Card_reveal_time;